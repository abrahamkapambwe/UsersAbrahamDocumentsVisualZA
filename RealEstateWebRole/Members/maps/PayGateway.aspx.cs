    ...
    public partial class PayGateway : System.Web.UI.Page
    {
        ...
        protected void Edit_OnClick(object sender, EventArgs e)
        {
            ...
            else if (lkBEdit.Text == "Save")
            {
                ...
                if (ddlAmountEdit.SelectedValue == "100")
                {
                    lblAmount.Text = "R 100";
                ...
                else if (ddlAmountEdit.SelectedValue == "200")
                {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (Request.QueryString["propertyId"] != null)
            {
                ...
                if (property != null)
                {
                    ...
                    builder.Append("http://epropertysearchza.apphb.com/Members/UploadPictures.aspx?moneybookerstatus=success&propId=" + propertyID);
                    builder.Append(";");
                    builder.Append("http://epropertysearchza.apphb.com/Members/UploadPictures.aspx?moneybookerstatus=cancel&propId=" + propertyID);
                    builder.Append(";");
