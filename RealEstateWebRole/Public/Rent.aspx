...
<%@ Register Src="../Controls/SearchMap.ascx" TagName="SearchMap" TagPrefix="uc2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 ...
 for rent on ePropertySearch for free!" NavigateUrl="~/Members/UploadPicturesza.aspx"></asp:HyperLink>
            </span>
        </div>
    </div>
    <div>
