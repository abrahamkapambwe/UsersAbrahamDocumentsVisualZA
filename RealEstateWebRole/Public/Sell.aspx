...
<%@ Register Src="../Controls/SearchMap.ascx" TagName="SearchMap" TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 ...
 for sale on ePropertySearch for free!" NavigateUrl="~/Members/UploadPicturesza.aspx"></asp:HyperLink></span>
        </div>
    </div>
    <div>
